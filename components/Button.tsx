...
const Button = ({
  ...
  const normalStyle = className ? className : "bg-purple-500 text-white";
  const hoverStyle = hoverClassName ? hoverClassName : "hover:bg-purple-700";
  ...
  return (
    <button
      ...
      } py-1 px-4 rounded font-semibold inline-flex items-center focus:outline-none`}
      onClick={handleClick}
    >
      {text}
      {loading ? (
